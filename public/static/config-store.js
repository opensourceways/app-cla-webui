module.exports = {
    ...
    EMAIL_UNAUTHORIZE : 'refuse_to_authorize_email',
    NO_PUBLIC_EMAIL : 'no_public_email',
    SYSTEM_ERROR : 'system_error',
    EMAIL_ERROR : 'error_code',
    GITEE_CHECK_REPO_401_ERROR_PRIVATE : '401 Unauthorized: no \'projects\' scope',
    GITEE_CHECK_REPO_401_ERROR_TOKEN_EXIST : '401 Unauthorized: Access token does not exist',
    PWD_MIN_LENGTH : 8,
    PWD_MAX_LENGTH : 18,
    PWD_MIN_ASCII : 33,
    PWD_MAX_ASCII : 126,
    EMAIL_REG : /^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*\.[a-zA-Z]{2,6}$/,
    COPYRIGHT : 'MIT Licensed | Copyright © opensourceways infrastructure | ',
    ICP : '蜀ICP备20009468号-1',
    ICP_LINK : 'https://icp.chinaz.com/home/info?host:osinfra.cn',
    POLICE_RECORD : '粤公网安备 44030702003822号',
    POLICE_RECORD_LINK : 'http://www.beian.gov.cn/portal/registerSystemInfo?recordcode:44030702003822',
    PRIVACY_POLICY_DATA : [                            //如需添加其他语言的隐私声明，只需按照数组中对象的格式添加一个对象即可
        {
    ...
    OPENLOOKENG_SIGN_URL : 'https://clasign.openlookeng.io',
    OPENLOOKENG_LINKID : 'gitee_openlookeng-1614322910578209320',
}