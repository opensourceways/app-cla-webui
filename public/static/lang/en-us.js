module.exports = {
    signType: {
        ...
        corpBt: ' Sign Corporation DCO ',
        empBt: ' Sign Employee DCO ',
        individualBt: ' Sign Individual DCO ',
        guideTitle: 'Signing DCO Guide for',
        mobileGuideTitle: 'Guide for...',
        corpStep1_1: 'If you are signing the DCO as an enterprise that wants to contribute code to the community, please click "',
        corpStep1_2: '" to go to the DCO signing page.',
        corpStep2: 'Fill in the information and submit for signature.',
        corpStep3: 'Receive an e-mail from the community to sign the enterprise DCO. Follow the instructions in the e-mail to sign the DCO.',
        corpStep4: 'The community administrator approves the DCO file signed by the enterprise and enables the administrator account of the enterprise in the community.',
        corpStep5: 'Receive an e-mail containing the administrator account, indicating that the DCO is signed successfully.',
        corpStep6_1: 'Log in to the',
        corpStep6_2: 'add an employee as administrator, and download the enterprise DCO file.',
        empStep1_1: 'If you have signed the DCO as an employee of a company that has signed the DCO, please click“',
        individualStep1_1: 'If you are an independent developer or your company has not signed the enterprise DCO with the community, please click“',
        claSignPlatform: ' DCO signing platform ',
        empStep2: 'Agree to access your authorize account on the DCO signing platform and go to the employee DCO signing page.',
        empStep4: 'Wait for the administrator of your enterprise in the community to activate the signed DCO file you submitted.',
        empStep5: 'Receive an e-mail indicating that the DCO is signed and activated.',
        individualStep2: 'Agree to access your authorize account on the DCO signing platform and go to the individual DCO signing page.',
        individualStep4: 'Receive an e-mail indicating that the the DCO is signed and activated.',
    ...
    tips: {
        ...
        dialogBt: 'OK',
        no_cla_binding_corp: 'There is no DCO to sign for corporation.',
        no_cla_binding_emp: 'There is no DCO to sign for employee.',
        no_cla_binding_individual: 'There is no DCO to sign for individual.',
        has_signed: 'You have signed this DCO before.',
        corp_has_signed: 'The corporation has  signed this DCO before.',
        invalid_parameter: 'The parameter is invalid and cannot be signed',
        no_corp_manager: 'Your company has not signed corporation DCO or added any manager. You can\'t sign as employee',
        ...
        id_pwd_err_new: 'Account or password error,',
        id_pwd_err_corp: 'Post freeze',
        user_login_frozen:'The account has been frozen and will be retried in five minutes',
        ...
        paste_individual_link: 'Please paste the DCO link applied to the individual signature',
        select_individual_language: 'Please select the language to apply to the DCO signed by the individual',
        paste_corp_link: 'Please paste the DCO link applied to the corporation signature',
        select_corp_language: 'Please select the language to apply to the DCO signed by the corporation',
        ...
        no_link: 'The community has not been bound to DCO',
        unmatched_cla: 'The current DCO is not the latest DCO, please refresh the page and try again',
        ...
        cla_is_used: 'The DCO has been used',
        go_to_sign_employee_cla: 'Your company has signed corporation DCO, so you can only sign employee DCO',
    ...
    org: {
        ...
        unlink_desc1: 'Remove the DCO assistant webhook in your repository/organization',
        ...
        individual_cla: 'Individual DCO',
        toLanguage: 'Language',
        modify_field: 'Modify field',
        delete_cla: 'Delete DCO',
        add_cla_for_other_language: 'Add DCO for other language',
        corporation_cla: 'Corporation DCO',
        download: 'download',
        preview: 'preview',
        ...
        config_cla_select_org: 'Select an organization that needs to configure DCO',
        ...
        config_cla_select_repo: 'If you want to configure DCO for a repository under the organization, please enter the repository. If not, please ignore it',
        ...
        config_cla_email_authorize_desc: 'DCO system will...',
        ...
        config_cla_paste_url_title: 'Paste a url of a DCO file',
        config_cla_paste_url_title_tooltips: 'Paste a url to the original data of a DCO in the repository',
        config_cla_paste_individual_url: 'Individual DCO url',
        config_cla_individual_url_desc: 'You need to paste a download address of PDF file applied to individual DCO from {platform} public repository',
        config_cla_url_placeholder: 'Paste a Url',
        config_cla_individual_lang: 'Individual DCO language',
        config_cla_select_lang: 'select language',
        config_cla_corp_url: 'If you need your community support corporation to sign up for DCO, please complete the following information. If not, please ignore it',
        config_cla_paste_corp_url: 'Corporation DCO url',
        config_cla_corp_url_desc: 'You need to paste a download address of PDF file applied to corporation DCO from {platform} public repository',
        config_cla_corp_lang: 'Corporation DCO language',
        config_cla_download_empty_signature_tips: 'Please select the language of the signature page to be downloaded first',
        config_cla_fields: 'Edit DCO\'s Fields',
        config_cla_fields_desc: 'The information you want contributors to fill in when they sign the DCO.Title and type are required, otherwise the field will fail to be added',
        ...
        config_cla_check_url_title: 'Url of DCO file',
        config_cla_check_fields_title: 'DCO\'s Fields',
        ...
        addIndividualCla: 'Add individual DCO',
        addCorpCla: 'Add corporation DCO',
        invalidSignature: 'Deleted Corporation',
        reduction: 'Reduction',
        deleteCompletely: 'Delete Completely',
        date: 'Date',
        cla_language: 'DCO Language',
        not_complete: 'Not Complete',
        complete: 'Complete',
        cla_format_err: 'DCO file must be pdf'
    }
};
