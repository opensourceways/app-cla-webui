module.exports = {
    signType: {
        ...
        corpStep1_1: '如果你是作为一家想要为社区贡献代码的企业来签署 CLA，请点击“',
        corpStep1_2: '”进入 CLA 签署页面',
        corpStep2: '填写各项信息，提交签署',
        corpStep3: '企业将接收到社区发出的签署企业 CLA 的文件，请按照邮件中的提示完成后续签署',
        corpStep4: '社区管理员审批企业签署的企业 CLA 文件，开通企业在该社区的 Administrator 账号',
        corpStep5: '企业收到包含 Administrator 账号的邮件，企业 CLA 签署成功',
        corpStep6_1: '企业登录',
        corpStep6_2: '增加员工管理员，下载企业 CLA 文件等',
        empStep1_1: '如果你是作为一家已经签署了企业 CLA 的企业的员工共来签署 CLA，请点击“',
        individualStep1_1: '如果你是一名独立开发者或者你所在的企业还未与社区签署企业 CLA，请点击“',
        claSignPlatform: 'CLA 签署平台',
        empStep2: '同意 CLA 签署平台对您授权账号的访问授权跳转至员工 CLA 签署页面',
        empStep4: '等待您公司在该社区的管理员对您提交的签署进行激活',
        empStep5: '收到员工 CLA 签署生效的邮件签署完成',
        individualStep2: '同意 CLA 签署平台对您授权账号的访问授权跳转至个人 CLA 签署页面',
        individualStep4: '收到个人 CLA 签署生效的邮件签署完成',
    ...
    tips: {
        ...
        go_to_sign_employee_cla: '你所在的公司已经签署企业 CLA，所以你只能签署员工 CLA',
    ...
    org: {
        ...
        config_cla_select_repo: '如果你想为选择的组织下的某一个特定仓库配置 CLA, 就请输入仓库名. 如果不需要, 请忽略',
        ...
        config_cla_paste_url_title_tooltips: '粘贴一个在仓库中的 CLA 文件的原始数据地址',
        config_cla_paste_individual_url: '个人 CLA 地址',
        config_cla_individual_url_desc: '你需要粘贴一条来自 {platform} 公开仓库的应用于个人 CLA 的 PDF 文件的下载地址',
        ...
        config_cla_corp_url_desc: '你需要粘贴一条来自 {platform} 公开仓库的应用于企业 CLA 的 PDF 文件的下载地址',
        config_cla_corp_lang: '企业 CLA 语言',
        config_cla_download_empty_signature_tips: '下载原始文件之前，请先选择企业 CLA 语言',
    ...
    new:{
        corporation:'如果你对该项目的贡献内容属于你所在的企业/组织，或者你是企业/组织的CLA管理员，请点击“企业/组织贡献”进行操作',
        individual:'如果你对该项目的贡献内容属于你自己，而不是你所在的企业/组织，请点击“个人贡献”进行签署',
        corp:'如果你所在的企业/组织还未签署CLA,而你已获得授权代表企业/组织进行签署，请点击“签署”进行签署。',
        employee:'你所在企业/组织签署CLA后，你可以点击“贡献者登记”登记你为所在企业/组织的贡献者。',
        manager:'如果你对该项目的贡献内容属于你所在的企业/组织，或者你是企业/组织的CLA管理员，请点击“企业/组织贡献”进行操作',
        sign:'CLA签署',
        contribution:'企业/组织贡献',
        register:'贡献者登记',
        manage:'管理者登陆'
    }
};
