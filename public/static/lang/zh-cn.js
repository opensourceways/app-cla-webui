module.exports = {
    signType: {
        ...
        corpBt: '签署企业 DCO',
        empBt: '签署员工 DCO',
        individualBt: '签署个人 DCO',
        guideTitle: 'DCO 签署指引',
        mobileGuideTitle: '签署指引',
        corpStep1_1: '如果你是作为一家想要为社区贡献代码的企业来签署 DCO，请点击“',
        corpStep1_2: '”进入 DCO 签署页面',
        corpStep2: '填写各项信息，提交签署',
        corpStep3: '企业将接收到社区发出的签署企业 DCO 的文件，请按照邮件中的提示完成后续签署',
        corpStep4: '社区管理员审批企业签署的企业 DCO 文件，开通企业在该社区的 Administrator 账号',
        corpStep5: '企业收到包含 Administrator 账号的邮件，企业 DCO 签署成功',
        corpStep6_1: '企业登录',
        corpStep6_2: '增加员工管理员，下载企业 DCO 文件等',
        empStep1_1: '如果你是作为一家已经签署了企业 DCO 的企业的员工共来签署 DCO，请点击“',
        individualStep1_1: '如果你是一名独立开发者或者你所在的企业还未与社区签署企业 DCO，请点击“',
        claSignPlatform: 'DCO 签署平台',
        empStep2: '同意 DCO 签署平台对您授权账号的访问授权跳转至员工 DCO 签署页面',
        empStep4: '等待您公司在该社区的管理员对您提交的签署进行激活',
        empStep5: '收到员工 DCO 签署生效的邮件签署完成',
        individualStep2: '同意 DCO 签署平台对您授权账号的访问授权跳转至个人 DCO 签署页面',
        individualStep4: '收到个人 DCO 签署生效的邮件签署完成',
    ...
    tips: {
        ...
        no_corp_manager: '你所属的公司暂未签署企业 DCO 或者尚未添加任何管理员。你无法进行员工签署',
        ...
        paste_individual_link: '请粘贴应用于个人签署的 DCO 链接',
        select_individual_language: '请选择应用于个人签署的 DCO 的语言',
        paste_corp_link: '请粘贴应用于企业签署的 DCO 链接',
        select_corp_language: '请选择应用于企业签署的 DCO 的语言',
        ...
        no_link: '该社区尚未绑定 DCO',
        unmatched_cla: '当前的 DCO 不是最新的 DCO，请刷新页面后重试',
        link_exists: '该社区已经存在绑定信息',
        checkRepoMessage: '您输入的仓库不属于该组织或者该仓库为私有仓库或者该仓库不存在，是否继续？',
        cla_is_used: '该 DCO 已经被使用',
        go_to_sign_employee_cla: '你所在的公司已经签署企业 DCO，所以你只能签署员工 DCO',
        ...
        not_support_platform: '暂不支持该平台的隐私声明，请将隐私声明存储到 Gitee 或者 Github 的公开仓库',
    ...
    corp: {
        ...
        newPwd_contains_Illegal_character: '新密码长度必须是{minLength}-{maxLength}位，至少包含大写字母、小写字母、数字、特殊字符中的三种',
    ...
    org: {
        ...
        resend_tip: '如果企业签署之后未收到包含需要企业签名的 PDF 的邮件，你可以点击这里重新发送',
        configure_bt: '配置 DCO',
        linked_tab: '已绑定的仓库',
        repository: '仓库',
        organization: '组织',
        ...
        unlink_p: '你确定想要解绑?',
        unlink_will: '解绑将会...',
        unlink_desc1: '删除仓库/组织中的 DCO assistant webhook',
        unlink_desc2: '删除组织/仓库与 DCO 的绑定',
        keep_it: '取消',
        select_file: '选择文件',
        upload: '上传',
        ...
        resend_email: '重发邮件',
        individual_cla: '个人 DCO',
        toLanguage: '语言',
        modify_field: '调整字段',
        delete_cla: '删除 DCO',
        add_cla_for_other_language: '添加其他语言的 DCO',
        corporation_cla: '企业 DCO',
        download: '下载',
        preview: '预览',
        upload_file: '上传文件',
        select: '选择',
        ...
        config_cla_select_org: '选择一个需要配置 DCO 的组织',
        ...
        config_cla_select_repo: '如果你想为选择的组织下的某一个特定仓库配置 DCO, 就请输入仓库名. 如果不需要, 请忽略',
        ...
        config_cla_email_authorize_desc: 'DCO 系统将...',
        ...
        config_cla_paste_url_title: '粘贴一个 DCO 文件的地址',
        config_cla_paste_url_title_tooltips: '粘贴一个在仓库中的 DCO 文件的原始数据地址',
        config_cla_paste_individual_url: '个人 DCO 地址',
        config_cla_individual_url_desc: '你需要粘贴一条来自 {platform} 公开仓库的应用于个人 DCO 的 PDF 文件的下载地址',
        config_cla_url_placeholder: '粘贴一个地址',
        config_cla_individual_lang: '个人 DCO 语言',
        config_cla_select_lang: '选择语言',
        config_cla_corp_url: '如果你需要让你的设置支持企业签署，请填写以下信息，如果不需要，请忽略',
        config_cla_paste_corp_url: '企业 DCO 地址',
        config_cla_corp_url_desc: '你需要粘贴一条来自 {platform} 公开仓库的应用于企业 DCO 的 PDF 文件的下载地址',
        config_cla_corp_lang: '企业 DCO 语言',
        config_cla_download_empty_signature_tips: '下载原始文件之前，请先选择企业 DCO 语言',
        config_cla_fields: '编辑 DCO 的字段',
        ...
        config_cla_check_url_title: 'DCO 文件地址',
        config_cla_check_fields_title: 'DCO 的字段',
