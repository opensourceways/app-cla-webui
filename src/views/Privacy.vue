    ...
    export default {
        ...
        watch: {
            '$i18n.locale'() {
                ...
                // this.privacyData[this.value].platform, this.privacyData[this.value].owner, this.privacyData[this.value].repo, this.privacyData[this.value].path
            }
        },
        data() {
            return {
