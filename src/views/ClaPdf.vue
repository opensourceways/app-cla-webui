            ...
            setClaText(obj) {
                ...
                if (dataFromParent.pdfData && dataFromParent.pdfData.length) {
                    for (let i = 0; i < dataFromParent.pdfData.length; i++) {
                        // dataFromParent.pdfData[i].hasOwnProperty(dataFromParent.lang)
                        if (Object.prototype.hasOwnProperty.call(dataFromParent.pdfData[i],dataFromParent.lang)) {
                ...
                } // dataFromParent.hasOwnProperty('pdfData')
