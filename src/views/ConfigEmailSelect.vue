        ...
        <el-dialog
            ...
            <div>
                ...
                <el-row v-if="emailType === TENCENT_EMAIL" class="tencent-form">
                    <el-col :offset="2" :span="20">
                        <el-form label-position="left" :label-width="labelWidth" :model="emailForm" :rules="rules" ref="emailForm">
            ...
            rules() {
                return {
                    email: [
                        ...
                        { pattern: claConfig.EMAIL_REG, message: this.$t('tips.not_fill_email'), trigger: 'blur' },
                    ],
                    authorizeCode: [
