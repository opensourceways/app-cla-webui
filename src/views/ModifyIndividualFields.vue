  ...
  <el-row id="configFields">
    <div class="itemBox">
      ...
      <div class="margin-top-1rem">
        <div>
          <div class="margin-top-1rem">For Individual Metadata</div>
          <div class="margin-top-1rem">
            <div class="margin-top-1rem">
              Configure the required field information for individual and
              employee signers
            </div>
            <div>
              <el-row
            ...
            <div>
              ...
              >
                ...
                <el-col :span="4">
                  ...
                  <el-button @click="myDeleteRow(index)" size="medium"
                    >-</el-button
                  >
                </el-col>
              </el-row>
